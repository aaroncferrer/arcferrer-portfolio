    ...
    <header ref={headerRef}>
      ...
      >
        ...
        <motion.p variants={item}>
          Software engineer well-versed in account management and fullstack
          development with demonstrated skills in frontend and graphic design.
          Dynamic, detail-oriented, and a self-driven tech enthusiast who makes
          sure to get the job done.
        </motion.p>

        <motion.div className="header__buttons" variants={item}>
          <a href={Resume} download className="btns btn-primary">
            Download Resumé
          </a>
          <a href="#projects" className="btns btn-secondary">
            View Projects
          </a>
        </motion.div>
      </motion.div>
